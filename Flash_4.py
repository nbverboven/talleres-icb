...
# Verifica que haya una sola reina en las diagonales que atraviesan la posicion
...
# Una consideracion que se tuvo con el fin de reducir el tiempo de ejecucion (no en el peor caso) 
# fue que, si se logra ubicar a una reina en una posicion, la funcion no sigue probando con 
# las columnas restantes sino que prosigue a la siguiente fila. 
